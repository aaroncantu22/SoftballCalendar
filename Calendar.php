...
echo "<button class='add-button' id='openAppointmentForm'>Schedule an Appointment</button>";
echo "</div>";
...
<div id="appointmentModal" class="modal">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            ...
            <a href="" id="edit-Button" class="action-button"><i class='fas fa-pencil-alt'></i></a>
