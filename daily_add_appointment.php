...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $override_gap = filter_input(INPUT_POST, 'override_gap', FILTER_VALIDATE_BOOLEAN);
        ...
        // Calculate the 10-minute gap
        $gap = new DateInterval('PT10M');
        ...
        foreach ($appointments as $appointment) {
            ...
            if (!$override_gap && (($startDate < $requiredStartAfter && $endDate > $existingStart) ||
         ...
         if ($conflict) {
            ...
            echo "<div class='nav-buttons'>";
            // Use the formatted appointment date to return to the correct calendar
