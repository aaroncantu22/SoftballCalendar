...
try {
    ...
    $timeGap = isset($_GET['gap']) ? (int)$_GET['gap'] : 60; // Default to 45 minutes
        ...
        <div class="appointment-form">
            <form action="daily_add_appointment.php" method="post">
                ...
                <div class="checkbox-container">
                    <input type="hidden" name="override_gap" value="0">
                    Override 10-minute gap
                    <input type="checkbox" id="override_gap" name="override_gap" value="1" class="small-text-checkbox">
                    <label for="override_gap" class="small-text"></label>
                </div><br>
